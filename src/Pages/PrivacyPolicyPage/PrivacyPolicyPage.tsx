...
const PrivacyPolicyPage = () => {
  return (
    <>
      ...
      <TermsContainer className="privacy-policy-page">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Janus LLC, Tel aviv.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Janus.- It's your data,
              accessible from{' '}
              <a
                href="https://www.janus.com"
        ...
        <ul>
          <li>By email: din.ashkenazi@janus.ac</li>
        </ul>
      </TermsContainer>
    </>
  );
